...
export default function packageMenu() {
  return (
    <div className="flex flex-row bg-gradient-to-b from-[#EFF6FD] to-white relative overflow-hidden w-full h-full min-h-[100vh]">
      ...
      <div className="flex flex-col w-full h-screen overflow-auto mt-10 lg:mt-10">
        ...
        <div className="flex flex-row justify-end items-center mr-[20px] lg:mr-[60px] mt-[28px] lg:mt-[20px] lg:text-[24px] gap-1">
