...
export default function MarkAsRead(){
    ...
    const handleMarkAsRead = async () => {
        try {
          const res = await fetch("http://localhost:3000/api/change-update-status", {
            method: "PATCH",
            headers: {
    ...
    return (
    <button onClick={handleMarkAsRead} className={`bg-green-800 px-4 py-1 lg:px-[26px] lg:py-[6px] rounded-[25px] flex items-center justify-center mt-8 hover:shadow-[0_4px_4px_0px_rgba(0,0,0,0.25)] ${
